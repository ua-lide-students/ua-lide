...
class ProjectController
{
    ...
    public function createProjectAction(Request $request) {
        ...
        try {
            ...
            if (!empty($this->getDoctrine()->getRepository('App:Projet')
            ...
            $filesystem = '%env(root_users_filesystem)%';
    ...
    public function getProjectAction(Request $request) {
        $projet = $this->getDoctrine()->getRepository('App:Projet')
    ...
    public function getProjectsAction(ParamFetcherInterface $paramFetcher) {
        ...
        $projectRepository = $this->getDoctrine()->getRepository('App:Projet');
    ...
    public function deleteProjectAction(Request $request) {
        ...
        try {
            ...
            $files = $this->getDoctrine()->getRepository('App:Fichier')
