...
return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 1 => ${($_ = isset($this->services['security.context_listener.3']) ? $this->services['security.context_listener.3'] : $this->load('getSecurity_ContextListener_3Service.php')) && false ?: '_'};
